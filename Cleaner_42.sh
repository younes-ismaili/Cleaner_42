...
echo -e		" 		█▄▄ █▄▄ █▄▄ ██▄ █▀█ █░▀█ "
echo -en	"\n    	    	   By: "
echo -e 	"\033[33mOMBHD\033[0m [yismaili]\n"
...
then
	...
	if ! git clone --quiet https://github.com/younes-ismaili/Cleaner_42.git "$HOME"/"$tmp_dir" &>/dev/null;
	then
		sleep 0.5
...
echo -e		"		   GitHub   ~> \033[4;1;yismaili\033[0m"
echo -e		"	   	   42 Slack ~> \033[4;1;yismaili\033[0m\n"
